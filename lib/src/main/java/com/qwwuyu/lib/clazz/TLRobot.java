...
public class TLRobot {
    public static String requestTL(String key, String userId, String txt) {
        try {
            String post = GsonHelper.toJson(new TLRequest(key, userId, txt));
            ...
            if (conn.getResponseCode() == 200) {
                ...
                String result = new String(toByteArray(inStream), StandardCharsets.UTF_8);
                TLResponse tlResponse = GsonHelper.fromJson(result, TLResponse.class);
                if (tlResponse == null) return null;
    ...
    private static class TLRequest {
        ...
        private static class Perception {
