...
<div class="content w960 center">
    <form>
        ...
        <textarea id="content" class="textarea" maxlength="500" rows="4" placeholder="内容" autocomplete="off" style="margin-top: 12px;"></textarea>
        <button id="send_note" class="btn" style="width: 100px; margin-top: 12px;">发表</button>
    </form>
</div>
