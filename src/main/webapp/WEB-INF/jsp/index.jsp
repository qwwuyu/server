...
<div class="content w960 center">
    <div class="nav">
        <ul>
            <li>
                <a id="card" href="/card" class="nav-a"><i class="nav-ion ion-compose"></i><span class="nav-span">card</span></a>
            </li>
            <li>
                <a id="flag" href="/flag" class="nav-a"><i class="nav-ion ion-social-facebook-outline"></i><span class="nav-span">flag</span></a>
            </li>
            <li>
                <a id="note" href="/note" class="nav-a"><i class="nav-ion ion-clipboard"></i><span class="nav-span">note</span></a>
            </li>
            <li style="display: none;">
                <a id="tool" href="/tool" class="nav-a"><i class="nav-ion ion-settings"></i><span class="nav-span">tool</span></a>
            </li>
        </ul>
    </div>
