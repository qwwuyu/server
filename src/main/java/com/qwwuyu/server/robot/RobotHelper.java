...
public class RobotHelper {
    ...
    public synchronized void openRobot() throws Exception {
        ...
        try {
            ...
            PicqBotX bot = new PicqBotX(new PicqConfig(SecretConfig.coolqPort + 2).setDebug(false));
            bot.addAccount("kere", "127.0.0.1", SecretConfig.coolqPort + 1);
        ...
        try {
            ...
            PicqBotX bot = new PicqBotX(new PicqConfig(SecretConfig.coolqPort + 5).setDebug(false));
            bot.addAccount("kere", "127.0.0.1", SecretConfig.coolqPort + 4);
